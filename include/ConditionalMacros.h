...
#    define FUNCTION_DECLSPEC       0 /* QuickTime for Windows cannot use dllimport */
#   endif /* !FUNCTION_DECLSPEC */
#   ifndef FUNCTION_WIN32CC  /* allow calling convention to be overridden */
#    define FUNCTION_WIN32CC        1
#   endif /* !FUNCTION_WIN32CC */
...
/* Set forCarbon to 0 if it is/was not already defined */
# ifndef forCarbon
#  define forCarbon 0
...
/*
 * It is possible to have ACCESSOR_CALLS_ARE_FUNCTIONS set to true and OPAQUE_TOOLBOX_STRUCTS
...
# endif /* TARGET_RT_MAC_MACHO && TARGET_RT_LITTLE_ENDIAN */
